DEFAULT_PASSWORD_ADMIN = 'ZXDas7966mby@'.freeze
DEFAULT_PASSWORD_USER = '123456'.freeze

Admin.create!(email: 'admin1@credishop.com', password: DEFAULT_PASSWORD_ADMIN, password_confirmation: DEFAULT_PASSWORD_ADMIN)
