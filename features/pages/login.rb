class Login < SitePrism::Page # Está herdando os métodos de SitePrism::Page
  ...
  element :input_email, '#admin_email' # Encontrando o elemento de input de email
  element :input_password, '#admin_password' # Encontrando o elemento de input de password
  ...
  def login(email, password) # Método que faz login passando as variáveis email e password
    ...
    click_button 'Entrar' # Seleciona o botão com o texto 'Sign in'
  end
